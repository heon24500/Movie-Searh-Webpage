<template>
  <div class="movie-detail">
     <div v-if="movieDetail && movieDetail.backdrop_path" class="movie-detail-image" :style="{backgroundImage: `url(${image(movieDetail.backdrop_path)})`}"></div>
     <div class="movie-content d-flex">
       ...
       <div class="ml-4 w-75">
         ...
         <div class="text-white movie-information-wrapper mt-4 d-flex align-items-center">
           ...
           <a v-if="movieDetail.homepage" class="ml-1 h4 hompage-link text-white" target="_blank" :href="movieDetail.homepage">
